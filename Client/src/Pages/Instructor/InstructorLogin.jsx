                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 lg:gap-10">
                        ...
                        <div className="space-y-6 bg-white p-4 sm:p-6 rounded-xl border border-gray-200 shadow-sm">
                            <div className="space-y-4">
                                ...
                                <MediaUpload files={formData.mediaFiles} onChange={handleMediaFilesChange} onRemove={removeMediaFile} />

                                <DocumentUpload
                                    certificate={formData.certificate}
                                    governmentId={formData.governmentId}
                                    onCertificateChange={(file) => handleDocumentChange("certificate", file)}
                                    onGovernmentIdChange={(file) => handleDocumentChange("governmentId", file)}
                                />
                            </div>
                        </div>
                    </div>
